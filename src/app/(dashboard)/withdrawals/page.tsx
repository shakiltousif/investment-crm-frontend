          ...
          <div className="bg-white rounded-lg shadow p-4 mb-4">
            <div className="flex justify-between items-center">
              ...
              <div className="text-sm text-gray-600">
                Showing {((currentPage - 1) * itemsPerPage) + 1} to {Math.min(currentPage * itemsPerPage, withdrawals.length)} of {withdrawals.length} withdrawals
              </div>
            </div>
          </div>
        ...
        {withdrawals.length > itemsPerPage && (
          <div className="flex justify-between items-center mt-4">
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={() => setCurrentPage(prev => Math.min(Math.ceil(withdrawals.length / itemsPerPage), prev + 1))}
